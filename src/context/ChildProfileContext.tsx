...
function normalizeSavedRecipeMeal(meal: Meal): Meal {
  return {
    ...meal,
    name: meal.name || meal.nameEn || (meal as any).mealName || (meal as any).recipeName || (meal as any).title || meal.nameCn || meal.nameMs || '',
    nameEn: meal.nameEn || (meal as any).mealNameEn || (meal as any).recipeNameEn || (meal as any).titleEn || meal.name || (meal as any).mealName || (meal as any).recipeName || (meal as any).title || meal.nameCn || meal.nameMs || '',
    nameCn: meal.nameCn || meal.strMealCn || meal.strMealCN || meal.strMealZh || (meal as any).mealNameCn || (meal as any).mealNameCN || (meal as any).mealNameZh || (meal as any).recipeNameCn || (meal as any).recipeNameCN || (meal as any).recipeNameZh || (meal as any).titleCn || (meal as any).titleCN || (meal as any).titleZh || '',
    nameMs: meal.nameMs || meal.strMealMs || (meal as any).mealNameMs || (meal as any).recipeNameMs || (meal as any).titleMs || '',
    strMeal: meal.strMeal || meal.name || (meal as any).mealName || (meal as any).recipeName || (meal as any).title || meal.nameEn || '',
    strMealEn: meal.strMealEn || (meal as any).mealNameEn || (meal as any).recipeNameEn || (meal as any).titleEn || meal.strMeal || meal.nameEn || meal.name || '',
    strMealCn: meal.strMealCn || meal.strMealCN || meal.strMealZh || meal.nameCn || (meal as any).mealNameCn || (meal as any).mealNameCN || (meal as any).mealNameZh || (meal as any).recipeNameCn || (meal as any).recipeNameCN || (meal as any).recipeNameZh || (meal as any).titleCn || (meal as any).titleCN || (meal as any).titleZh || '',
    strMealMs: meal.strMealMs || meal.nameMs || (meal as any).mealNameMs || (meal as any).recipeNameMs || (meal as any).titleMs || '',
    strInstructions: meal.strInstructions || (meal as any).method || (meal as any).directions || meal.strInstructionsEn || meal.instructions || meal.instructionsEn || '',
    strInstructionsEn: meal.strInstructionsEn || meal.instructionsEn || (meal as any).methodEn || (meal as any).directionsEn || meal.strInstructions || meal.instructions || (meal as any).method || (meal as any).directions || '',
    strInstructionsCn: meal.strInstructionsCn || meal.strInstructionsCN || meal.strInstructionsZh || meal.instructionsCn || meal.instructionsCN || meal.instructionsZh || (meal as any).methodCn || (meal as any).methodCN || (meal as any).methodZh || (meal as any).directionsCn || (meal as any).directionsCN || (meal as any).directionsZh || '',
    strInstructionsMs: meal.strInstructionsMs || meal.instructionsMs || (meal as any).methodMs || (meal as any).directionsMs || '',
    instructionsEn: meal.instructionsEn || meal.strInstructionsEn || (meal as any).methodEn || (meal as any).directionsEn || meal.strInstructions || meal.instructions || (meal as any).method || (meal as any).directions || '',
    instructionsCn: meal.instructionsCn || meal.instructionsCN || meal.instructionsZh || meal.strInstructionsCn || meal.strInstructionsCN || meal.strInstructionsZh || (meal as any).methodCn || (meal as any).methodCN || (meal as any).methodZh || (meal as any).directionsCn || (meal as any).directionsCN || (meal as any).directionsZh || '',
    instructionsMs: meal.instructionsMs || meal.strInstructionsMs || (meal as any).methodMs || (meal as any).directionsMs || '',
